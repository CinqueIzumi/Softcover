...
class ReviewRichTextTest {
    ...
    private fun mark(start: Int, end: Int, type: ReviewMarkType) =
        ReviewMark(start = start, end = end, type = type)

    private fun bold(start: Int, end: Int) = mark(start, end, ReviewMarkType.BOLD)
    private fun italic(start: Int, end: Int) = mark(start, end, ReviewMarkType.ITALIC)
    private fun spoiler(start: Int, end: Int) = mark(start, end, ReviewMarkType.SPOILER)
    ...
    inner class NormalizeMarks {
        ...
        fun `drops empty marks where start equals end`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 3, end = 3))
        ...
        fun `drops marks where start is greater than end`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 5, end = 2))
        ...
        fun `preserves a valid non-overlapping mark`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 0, end = 4))

            // ----- Act -----
            val result = normalizeMarks(marks = marks)

            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 4))
        }

        @Test
        fun `merges two overlapping marks of the same type`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 0, end = 5), bold(start = 3, end = 8))

            // ----- Act -----
            val result = normalizeMarks(marks = marks)

            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 8))
        }

        @Test
        fun `merges two touching marks of the same type`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 0, end = 4), bold(start = 4, end = 8))
        ...
        fun `leaves different-type marks independent`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 0, end = 4), italic(start = 0, end = 4))

            // ----- Act -----
            val result = normalizeMarks(marks = marks)

            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 4), italic(start = 0, end = 4))
        }
        ...
        fun `result is sorted by start then type`() {
            // ----- Arrange -----
            val marks = listOf(
                italic(start = 0, end = 2),
                bold(start = 0, end = 2),
                spoiler(start = 5, end = 9),
            )
        ...
        fun `merges three overlapping same-type marks into one`() {
            ...
            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 10))
        }
    ...
    inner class ApplyEditToMarks {
        ...
        fun `returns normalized marks unchanged when text is not changed`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 2, end = 6))

            // ----- Act -----
            val result = applyEditToMarks(marks = marks, oldText = "hello world", newText = "hello world")

            // ----- Assert -----
            result shouldBe listOf(bold(start = 2, end = 6))
        }
        ...
        fun `shifts mark right when insert is before mark start`() {
            ...
            val marks = listOf(bold(start = 6, end = 11))
            ...
            // ----- Assert -----
            result shouldBe listOf(bold(start = 9, end = 14))
        }
        ...
        fun `does not grow mark when insert is exactly at mark end`() {
            ...
            val marks = listOf(bold(start = 0, end = 5))
            ...
            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 5))
        }
        ...
        fun `shrinks mark when delete is fully inside it`() {
            ...
            val marks = listOf(bold(start = 0, end = 11))
            ...
            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 9))
        }
        ...
        fun `clips mark when delete spans its start`() {
            ...
            val marks = listOf(bold(start = 3, end = 9))
            ...
            result shouldBe listOf(bold(start = 0, end = 3))
        }
        ...
        fun `removes mark when delete covers it entirely`() {
            ...
            val marks = listOf(bold(start = 2, end = 8))
        ...
        fun `grows mark when insert is at exactly the mark start — start stays, end shifts`() {
            ...
            val marks = listOf(bold(start = 3, end = 7))
            ...
            // ----- Assert -----
            result shouldBe listOf(bold(start = 3, end = 9))
        }
    ...
    inner class IsRangeMarked {
        ...
        fun `returns true when mark exactly covers selection`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 2, end = 7))

            // ----- Act & Assert -----
            isRangeMarked(marks = marks, start = 2, end = 7, type = ReviewMarkType.BOLD) shouldBe true
        }

        @Test
        fun `returns true when mark is a superset of selection`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 0, end = 10))

            // ----- Act & Assert -----
            isRangeMarked(marks = marks, start = 3, end = 7, type = ReviewMarkType.BOLD) shouldBe true
        }
        ...
        fun `returns false for partial coverage`() {
            ...
            // ----- Act & Assert -----
            isRangeMarked(marks = marks, start = 3, end = 8, type = ReviewMarkType.BOLD) shouldBe false
        }
        ...
        fun `returns false for empty range`() {
            ...
            // ----- Act & Assert -----
            isRangeMarked(marks = marks, start = 5, end = 5, type = ReviewMarkType.BOLD) shouldBe false
        }
        ...
        fun `returns false when type does not match`() {
            ...
            // ----- Act & Assert -----
            isRangeMarked(marks = marks, start = 0, end = 5, type = ReviewMarkType.ITALIC) shouldBe false
        }

        @Test
        fun `returns false when marks list is empty`() {
            // ----- Act & Assert -----
            isRangeMarked(marks = emptyList(), start = 0, end = 5, type = ReviewMarkType.BOLD) shouldBe false
        }
    }
    ...
    inner class ToggleMark {
        ...
        fun `adds mark when selection is fully unmarked`() {
            ...
            // ----- Act -----
            val result = toggleMark(marks = marks, start = 2, end = 6, type = ReviewMarkType.BOLD)
        ...
        fun `removes mark when selection is fully marked`() {
            ...
            // ----- Act -----
            val result = toggleMark(marks = marks, start = 2, end = 7, type = ReviewMarkType.BOLD)

            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 2), bold(start = 7, end = 10))
        }

        @Test
        fun `removes only the selected portion when selection matches mark exactly`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 3, end = 8))

            // ----- Act -----
            val result = toggleMark(marks = marks, start = 3, end = 8, type = ReviewMarkType.BOLD)
        ...
        fun `is a no-op for collapsed selection`() {
            ...
            // ----- Act -----
            val result = toggleMark(marks = marks, start = 3, end = 3, type = ReviewMarkType.BOLD)
        ...
        fun `adds mark over partial coverage`() {
            ...
            // ----- Assert -----
            result shouldBe listOf(bold(start = 0, end = 7))
        }

        @Test
        fun `leaves other-type marks untouched when removing`() {
            // ----- Arrange -----
            val marks = listOf(bold(start = 0, end = 10), italic(start = 2, end = 6))

            // ----- Act -----
            val result = toggleMark(marks = marks, start = 0, end = 10, type = ReviewMarkType.BOLD)

            // ----- Assert -----
            result shouldBe listOf(italic(start = 2, end = 6))
        }
    }
    ...
    inner class RoundTrip {
        ...
        fun `documentToEditorBuffer then editorBufferToDocument returns canonical-equal document`() {
            ...
            val document = ReviewDocument(
                paragraphs = listOf(
                    ReviewParagraph(
                        runs = listOf(
                            ReviewRun(text = "Hello ", bold = false, italic = false, spoiler = false),
                            ReviewRun(text = "world", bold = true, italic = false, spoiler = false),
                        ),
                    ),
                    ReviewParagraph(runs = emptyList()),
                    ReviewParagraph(
                        runs = listOf(
                            ReviewRun(text = "italic", bold = false, italic = true, spoiler = false),
                            ReviewRun(text = " spoiler", bold = false, italic = false, spoiler = true),
                        ),
                    ),
                ),
            )
            ...
            val recovered = editorBufferToDocument(text = buffer.text, marks = buffer.marks)
        ...
        fun `editorBufferToDocument with known text and marks returns expected document`() {
            ...
            val marks = listOf(
                bold(start = 0, end = 4),
                spoiler(start = 11, end = 17),
            )

            // ----- Act -----
            val result = editorBufferToDocument(text = text, marks = marks)
            ...
            val expected = ReviewDocument(
                paragraphs = listOf(
                    ...
                    ReviewParagraph(
                        runs = listOf(
                            ReviewRun(text = "second", spoiler = true),
                        ),
                    ),
                ),
            )
        ...
        fun `run with all three marks survives round-trip`() {
            ...
            val document = ReviewDocument(
                paragraphs = listOf(
                    ReviewParagraph(
                        runs = listOf(
                            ReviewRun(text = "secret", bold = true, italic = true, spoiler = true),
                        ),
                    ),
                ),
            )
