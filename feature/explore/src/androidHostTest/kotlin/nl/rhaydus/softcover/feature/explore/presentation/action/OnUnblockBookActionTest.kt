...
class OnUnblockBookActionTest {
    ...
    inner class Execute {
        ...
        fun `invokes undoContinueSeriesBookDismissalUseCase with the given bookId`() = runTest {
            ...
            val action = OnUnblockBookAction(
                bookId = 42,
                title = "Dune",
                coverUrl = "cover.jpg",
        ...
        @Test
        fun `clicking Undo on the snackbar re-dismisses the book with the original metadata`() = runTest {
            // ----- Arrange -----
            val dependencies = stubDependencies(this)
            ...
            coEvery {
                dismissContinueSeriesBookUseCase(
                    bookId = 42,
                    title = "Dune",
                    coverUrl = "cover.jpg",
                    authorText = "Frank Herbert",
