...
> **Release notes (Google Play):**
> Your reading becomes personal. Rate any book on its detail page and draft your own review. Start a reading session from the Reading screen — a peek bar keeps the running timer and quick controls just above your nav, Focus Mode clears the screen for distraction-free reading, and a persistent notification keeps the book's cover and your running timer on the lock screen with pause, resume, stop, and even an "update page" control, so you can manage a session without opening the app. Pausing leaves idle time out of your recorded reading. A 21-day streak strip sits above your greeting. Preview any edition of a book — its cover, page count, publisher and ISBN — even before it's on your shelf, and the edition you picked comes with it when you add it. And scan a barcode to add any book — or the exact edition — straight to your library. Plus a handful of smaller fixes.
