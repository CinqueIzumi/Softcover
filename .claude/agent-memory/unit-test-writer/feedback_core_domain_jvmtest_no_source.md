...
Confirmed a third time for `:core:preferences`: an orchestrator's brief specified `./gradlew :core:preferences:testDebugUnitTest --tests "..."`, which failed outright ("task not found"). Re-ran with `testAndroidHostTest` and it worked as expected.
