...
- Off-scheme colors over imagery (cover scrims, camera-feed chrome) are treated as a **documented carve-out**, not a deduction — text over photographic content needs fixed-contrast white/black regardless of theme, and `DESIGN_SYSTEM.md` §2.1/§6 sanctions it as "the one place light-on-media copy is allowed."
