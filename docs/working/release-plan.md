...
- **Build/release** — Add CI/CD support for Google Play releases (automated build + signing + upload pipeline) so 3.0.0 can ship through automation rather than a manual store upload.
