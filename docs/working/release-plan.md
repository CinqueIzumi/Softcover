...
- **Fix** — Remember the last-used progress-entry unit (pages / time / percentage) and pre-select it next time — a lightweight last-used memory persisted across sessions, not a settings toggle. *(User request.)*
