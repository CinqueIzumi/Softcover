...
class RichTextEditingTest {
    ...
    inner class ToggleMark {
        ...
        fun `adds mark when selection is fully unmarked`() {
            // ----- Arrange -----
            val marks = emptyList<RichTextMark>()
    ...
    inner class RoundTrip {
        ...
        fun `documentToEditorBuffer then editorBufferToDocument returns canonical-equal document`() {
            ...
            val document = RichTextUiModel(
                paragraphs = persistentListOf(
                    ...
                    RichTextParagraph(runs = persistentListOf()),
                    RichTextParagraph(
                        runs = persistentListOf(
                            RichTextRun(
                                text = "italic",
        ...
        fun `document with empty paragraph survives round-trip`() {
            ...
            val document = RichTextUiModel(
                paragraphs = persistentListOf(
                    RichTextParagraph(runs = persistentListOf(RichTextRun(text = "first"))),
                    RichTextParagraph(runs = persistentListOf()),
                    RichTextParagraph(runs = persistentListOf(RichTextRun(text = "third"))),
                ),
            )
        ...
        fun `documentToEditorBuffer splits multi-paragraph doc with newline separator`() {
            ...
            val document = RichTextUiModel(
                paragraphs = persistentListOf(
                    RichTextParagraph(runs = persistentListOf(RichTextRun(text = "line one"))),
                    RichTextParagraph(runs = persistentListOf(RichTextRun(text = "line two"))),
                ),
            )
