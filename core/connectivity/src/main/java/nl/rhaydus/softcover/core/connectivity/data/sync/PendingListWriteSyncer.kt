...
class PendingListWriteSyncer(
    ...
    private suspend fun replayRemoveListBook(write: PendingListWrite) {
        ...
        val listBookId: Int = write.listBookId ?: error("REMOVE_LIST_BOOK replay missing listBookId")
    ...
    private suspend fun replayReorderListBooks(write: PendingListWrite) {
        ...
        val startPosition: Int = write.startPosition ?: error("REORDER_LIST_BOOKS replay missing startPosition")
