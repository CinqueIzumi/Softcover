...
class PendingListWriteSyncerTest {
    ...
    inner class DrainPendingWrites {
        ...
        @Test
        fun `replay failure halts drain — later entries are not replayed and attempts is incremented`() =
            runTest {
                // ----- Arrange -----
                val entityA = createListEntity(localId = 1L)
    ...
    inner class ReplayCreateList {
        @Test
        fun `delegates to remote createList with listName and caches the created BookList`() =
            runTest {
                // ----- Arrange -----
    ...
    inner class ReplayAddListBook {
        @Test
        fun `delegates to remote addBookToList then removes optimistic and caches real ListBook`() =
            runTest {
                // ----- Arrange -----
    ...
    inner class ReplayRemoveListBook {
        @Test
        fun `delegates to remote removeListBook with reconstructed ListBook and caches returned BookList`() =
            runTest {
                // ----- Arrange -----
